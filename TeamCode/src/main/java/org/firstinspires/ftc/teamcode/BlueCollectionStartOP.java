...
@Configurable // Panels
public class BlueCollectionStartOP extends OpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            Path1 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(22.000, 126.000), new Pose(41.000, 102.000))
                    )
            ...
            Path2 = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    ...
                                    new Pose(100.000, 50.000),
                                    new Pose(14.000, 10.000)
                            )
                    )
